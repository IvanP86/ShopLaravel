                    ...
                    <tr v-for="cart in cartsData" :key="cart">
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            <div>
                                ...
                                <input min="1" type="number" v-model="cart.qty" class="p-2 border w-1/4 border-gray-200"
                                    placeholder="Quantity" value="1" disabled>
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            <svg @click="destroyCart(cart)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-4 text-red-600 cursor-pointer">

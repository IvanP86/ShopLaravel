            ...
            <div class="flex items-start mb-4">
                ...
                <div>
                    <div class="p-4 mb-4 bg-white border border-gray-200">
                        ...
                        <div v-if="paramProducts.length > 0" class="mb-4">
                            <div v-for="paramProduct in paramProducts" :key="paramProduct"
                                ...
                                <div>
                                    <Link v-for="paramItem in paramProduct.data"
                                        class="inline-block mr-2 p-2 border border-gray-600 border-rounded"
                ...
                <!--        <div>
                            <div v-if="cartId">
                                ...
                                <input min="1" type="number" v-model=" cart.qty " class="p-2 border border-gray-200"
